...
int main(int argc, char* argv[]) {
    ...
    // Write symbols_per_sample and per-phase configuration so decoder is self-contained
    ...
    for (int s = 0; s < symbols_per_sample; ++s) {
        ...
        out.write(reinterpret_cast<char*>(&nctx), 1);
